...
- Let default preset-derived lists be edited, renamed, deleted, and reordered like regular saved lists.
...
- If the current profile already has that preset-derived list, choosing the preset opens the existing saved preset-derived list.
- If that preset-derived list does not exist, such as after deletion, the website creates the preset-derived list using that mode's format.
...
- The generated lists appear as regular cards in the To-do page list order.
...
- Users must be able to delete and reorder generated default preset-derived lists like regular saved lists.
