...
5. If the user currently has no lists, such as after deleting the generated default lists, the homepage shows an add-list card instead of a regular list card.
...
- [ ] Generated default preset-derived list cards behave like regular list cards and can be edited, renamed, deleted, and reordered.
