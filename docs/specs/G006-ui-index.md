...
The UI specs define the visual language, shared layout, component presentation, user feedback states, and accessibility requirements for the website.
...
- Feature specs define what users can do.
- UI specs define what the experience looks and feels like.
- Technical specs define data, routing, storage, runtime asset handling, and durable implementation mechanics.

## Related Specs

- `G002-rules.md` for universal rules and terminology.
- `G004-functional-map.md` for navigation and user flows.
- `technical/T004-runtime-assets-and-ui-implementation.md` for runtime asset handling and CSS ownership.
